...
/// An implementation of [MoiMeetPlatform] that uses method channels.
class MethodChannelMoiMeet extends MoiMeetPlatform {
  ...
  MoiMeetEventListener? _listener;
  ...
  Future<MethodResponse> join(
      MoiMeetConferenceOptions options, MoiMeetEventListener? listener) async {
    _listener = listener;
